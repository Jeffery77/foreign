...
class Arbs:
    ...
    def arb(self,names,odds,bookmakers,arb_urls,arb_opp,id_append,o_id,dont_add,books,driver,wait,n1='',n2=''):
        def get_team(text,url):
            ...
            if 'Winner' in text:
                ...
                # print(name[0])
            elif 'Both Teams To Score' in text:
                name = re.findall("(.*)(?:-.*)",text)
                market = 'soccer'
    ...
    def Both_Teams_To_Score(self,driver,wait):
        print("Beginning of Both Teams to score")
        change_market = wait.until(EC.presence_of_element_located((By.XPATH,'//div[@class="select-item selected beta-callout"]')))
        #change_market = driver
    ...
    def main(self):
       ...
       while True:
           for sp in new_urls:
               ...
               # self.Both_Teams_To_Score(driver1,wait1);
                print("End")
